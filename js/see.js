...
class MoviePage {
    ...
    createAdOverlay(containerSelector) {
        ...
        // Находим контейнер (плеер или трейлер)
        ...
        this.adOverlay.innerHTML = `
            <div style="position: relative; width: 100%; height: 100%; display: flex; justify-content: center; align-items: center; cursor: pointer;" onclick="window.moviePage.openAdLink()">
    ...
    closeAdOverlay() {
        ...
        // Удаляем обработчики resize/scroll
    ...
    openEpisodePlayer(season, episode) {
        ...
        // Показываем рекламный банер поверх плеера
        setTimeout(() => {
    ...
    closePlayerModal() {
        ...
        // Закрываем банер если он ещё открыт
    ...
    openTrailerModal() {
        ...
        // Показываем рекламный банер поверх трейлера (ОДИН В ОДИН как для плеера)
        setTimeout(() => {
