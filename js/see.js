...
class MoviePage {
    ...
    createAdOverlay(containerSelector) {
        ...
        const updatePosition = () => {
            ...
            this.adOverlay.style.top = (newRect.top - 4) + 'px';
            this.adOverlay.style.left = (newRect.left - 4) + 'px';
            this.adOverlay.style.width = (newRect.width + 8) + 'px';
            this.adOverlay.style.height = (newRect.height + 8) + 'px';
        };
